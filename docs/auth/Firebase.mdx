...
First install, import and configure [FirebaseUI](https://github.com/firebase/firebaseui-web) and [Firebase JS SDK](https://github.com/firebase/firebase-js-sdk).
...
import Login from 'numbani-react/ui/firebaseui/Login';
...
import FirebaseAuth from 'numbani-react/auth/provider/FirebaseAuth';
