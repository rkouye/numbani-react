...
**AuthService** is an interface defined by numbani-react to access the user login state, to log him out, to read user info and to subscribe to authentication event.
